...
with st.sidebar:
    ...
    <div style="background:#1e1e26;border-radius:10px;padding:14px 16px;margin-bottom:16px;">
        ...
        <div style="font-size:0.8rem;color:#9996a8;margin-bottom:6px;"><span class="status-dot"></span>Vector Store Active</div>
        <div style="font-size:0.8rem;color:#9996a8;"><span class="status-dot"></span>Direct Service Mode</div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("---")
    st.markdown('<div style="font-size:0.72rem;color:#4d4b5a;font-family:\'DM Mono\',monospace;line-height:1.7;">Bypasses FastAPI layer.<br>Direct Python service calls.</div>', unsafe_allow_html=True)
